package iot.entanglement.drone.dt;

import io.github.twinklekhj.ros.core.RosBridge;
import io.github.twinklekhj.ros.op.RosSubscription;
import io.vertx.core.json.JsonObject;
import iot.entanglement.drone.dt.ros_physical_adapter.RosBridgeClient;
import iot.entanglement.drone.dt.ros_physical_adapter.WebSocketRosPhysicalAdapter;
import iot.entanglement.drone.dt.ros_physical_adapter.WebSocketRosPhysicalAdapterConfiguration;
import iot.entanglement.drone.dt.ros_physical_adapter.exception.WebSocketRosPhysicalAdapterException;
import iot.entanglement.drone.dt.ros_physical_adapter.rostopic.DigitalTwinRosTopic;
import iot.entanglement.drone.dt.ros_physical_adapter.rostopic.RosTopicSubscribeFunction;
import iot.entanglement.drone.dt.modules.OdteManager;
import iot.entanglement.drone.dt.modules.RosPacketErrorDetector;
import iot.entanglement.drone.dt.ros.RosCommands;
import iot.entanglement.drone.dt.ros.px4_msgs.CustomVehicleOdometry;
import iot.entanglement.drone.dt.ros.px4_msgs.CustomVehicleStatus;
import iot.entanglement.drone.dt.utils.Vector3D;
...
public class DroneDigitalTwin {
    ...
    private static DigitalTwin createDigitalTwin(String droneId, Integer websocketServerPort, int targetSystem, Integer httpAdapterPort, Integer httpPrometheusServerPort,
        ...
        try {
            DroneDigitalTwinModel defaultShadowingFunction = new DroneDigitalTwinModel(droneId, odteManager, httpPrometheusServerPort, droneId, websocketServerId, sensorType, commType,
                    zoneId, zoneClass);
            ...
            RosBridgeClient rosBridgeClient1 = new RosBridgeClient("", websocketServerPort); // rosclient created
