...
import iot.entanglement.drone.dt.modules.BenchmarkModule;
import iot.entanglement.drone.dt.modules.CsvExporter;
import iot.entanglement.drone.dt.modules.OdteManager;
import iot.entanglement.drone.dt.utils.Vector3D;
import iot.entanglement.drone.dt.utils.TimestampedNotification;
...
public class DroneDigitalTwinModel extends DigitalTwinModel{
    ...
    Logger px4_shadowing_logger = LoggerFactory.getLogger(DroneDigitalTwinModel.class);
    ...
    public DroneDigitalTwinModel(String id, OdteManager odteManager, Integer httpPrometheusServerPort, String droneId, String wsId,
