package iot.entanglement.drone.dt.ros.px4_msgs;
...
@ToString
@Getter
public class CustomVehicleStatus extends RosMessage {
    public static final String TYPE = "px4_forwarder/msg/CustomVehicleStatus";

    // ==================== FIELDS ====================
    public static final String FIELD_SEQUENCE = "seq"; // Was not present in oroginal VehicleStatusMessage
    ...
    public static CustomVehicleStatus fromMessage(RosMessage m) {
        return CustomVehicleStatus.fromJsonObject(m.getJsonObject());
    }

    public static CustomVehicleStatus fromJsonObject(JsonObject jsonObject) {
        int seq = jsonObject.getInteger(FIELD_SEQUENCE, 0);  // ← lettura seq
    ...
    @Override
    public CustomVehicleStatus clone() {
        return new CustomVehicleStatus(this.timestamp, this.armingState, this.navState,
    ...
    public List<String> getLabels() {
        return Arrays.asList(
                ...
                "nav_state_desc",
                FIELD_FAILSAFE,
                FIELD_PRE_FLIGHT_CHECKS_PASS,
                FIELD_VEHICLE_TYPE,
                "vehicle_type_desc",
                FIELD_SYSTEM_ID,
                FIELD_COMPONENT_ID,
                FIELD_ARMING_REASON,
                FIELD_DISARMING_REASON,
                FIELD_FAILSAFE_DEFER_STATE,
                FIELD_HIL_STATE
        );
    }
    ...
    public List<Object> getValues() {
        ...
        values.add(latestArmingReason);
        values.add(latestDisarmingReason);
        values.add(failsafeDeferState);
        values.add(hilState);
